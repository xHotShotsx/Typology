...
- Alternatively, if you isolate the information metabolism elements (IMEs) as a unique set then there will still be 7 dichotomies, per system of dichotomies, in order to differentiste them distinctly.
- Here, I will present the 2 system of dichotomies (which keep the orbital dichotomies invariant) that can be used to define the set of IMEs.
