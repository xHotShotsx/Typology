...
Let a dichotomy be a partition: $$\mathfrak{d}_i = \{ \mathfrak{t}_{i,0}, \mathfrak{t}_{i,1} \}, \quad \mathfrak{t}_{i,0} \sqcup \mathfrak{t}_{i,1} = T$$The dichotomy function: $$ \mathfrak{d}_{i} : T \to \mathbb{Z}_{2} $$by
$$ \mathfrak{d}_{i}(t) := \begin{cases}
0 \quad \text{if } t \in \mathfrak{t}_{i,0} \\
1 \quad \text{if } t \notin \mathfrak{t}_{i,1} 
\end{cases} $$

We fix the sociotype ILE as the reference element and identify it with the zero vector. A
