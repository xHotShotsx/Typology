...
$\mathcal{O}$ denotes the set of orbital dichotomies generated by closure of the 2-cocycle interaction of wall dichotomies expressed in a dichotomy space $\mathfrak{D}$, with $\mathfrak{T}(\mathfrak{D})$ denoting the set of all traits that are generated by a set of dichotomies $\mathfrak{D}$.
...
2. Tencer, I. (2011). [*"The Mathematics of Socionics"*.](https://sedecology.com/math) Date accessed: 29/12/2025.
