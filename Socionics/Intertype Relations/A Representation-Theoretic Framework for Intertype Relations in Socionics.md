...
$\mathfrak{D}$ denotes a dichotomy algebra or "wall space" generated by a set of 8 wall dichotomies. When combined with the 7 orbital dichotomies, form a dichotomy system. Note: $\mathfrak{D}$ is used to denote the dichotomy system itself when the context makes the distinction clear.
$\mathcal{O}$ denotes the set of orbital dichotomies generated by closure of the 2-cocycle interaction of wall dichotomies expressed in a dichotomy space $\mathfrak{D}$, with $\mathfrak{T}(\mathfrak{D})$ being the set of all traits that are generated by a set of dichotomies $\mathfrak{D}$.
...
2. Tencer, I. (2011). [*"The Mathematics of Socionics"*.](https://www.scribd.com/document/486953825/socionics-math) Date accessed: 29/12/2025.
