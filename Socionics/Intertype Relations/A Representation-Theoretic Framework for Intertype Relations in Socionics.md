...
$\mathfrak{D}$ denotes a dichotomy algebra or "wall space" generated by a set of 8 wall dichotomies. When combined with the 7 orbital dichotomies, form a dichotomy system, with $\mathfrak{T}(\mathfrak{D})$ being the set of all traits that are generated by the set of dichotomies $\mathfrak{D}$.
