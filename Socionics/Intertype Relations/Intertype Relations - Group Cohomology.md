...
$H^0(\mathcal{D}_{i}, \ \mathbb{S})$ is the 0th cohomology of when a dichotomy system $\mathfrak{D}$ acts on the classical group of intertype relations $\mathbb{S}$. This is, by definition, the subgroup of all elements of $\mathbb{S}$ that are invariant under the action of $\mathfrak{D}$. More rigorously, this can be expressed as: $$H^0(\mathfrak{D, \mathbb{S}}) = \{r \in \mathbb{S} \ | \ \varphi(d)(r) = r, \ \forall d \in \mathfrak{D}\}$$