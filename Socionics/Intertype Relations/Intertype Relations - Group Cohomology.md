...
The cosets of $I_{\mathcal{D}_i}$ that are not in the subgroup itself: $$r I_{\mathcal{D}_{i}} = \{rs \mid s \in I_{\mathcal{D}_{i}}\},  \in \mathbb{S}$$ 
...
This "identity-superego" pair is fixed by all $\mathfrak{D}$-modules. It's the part of $\mathbb{S}$ invariant under _every_ dichotomy action, such that: $$Z_{\text{univ}} = \bigwedge_{i}H^0(\mathcal{D}_{i}, \mathbb{S})$$
