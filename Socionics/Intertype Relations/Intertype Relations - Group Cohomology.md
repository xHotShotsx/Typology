...
A set model is a set equipped with a well-defined action of some group. In the present framework, an $E_{16}$ set model is a set model that carries an action of the group which is the vector space representatio
