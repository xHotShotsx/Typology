...
For the cohomology of classical ITRs, we first define: $$\mathbf{V}_{i} := \text{the 4-dimensional vector space over } \mathbb{F}^4_{2} \text{ associated with a dichotomy system } \mathcal{D}_{i}.$$
