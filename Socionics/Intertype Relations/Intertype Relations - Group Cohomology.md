...
\end{cases}$$
In our framing, every type $t \in T$ can be defined by a 4-bit coordinate when fixing a dichotomy system, so that: $$\chi(t) = (\mathf_{1}(t), d_{2}(t), d_{3}(t), d_{4}(t)) \in \mathbb{Z}^4_{2}, \quad \mathfrak{d} \in \mathfrak{D}$$
