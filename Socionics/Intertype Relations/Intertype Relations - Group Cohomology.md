...
Then the selector intersection is the common refinement: $$\mathcal{P}_{i} = \bigcap_{s=1}^{m-1}\{ T_{s,0}, T_{s,1} \}$$which explicitly equals: $$\mathcal{P}_{i} = \{ \bigcap_{s=1}^{m-1} T_{s,\sigma_{s}}(t) \mid  $$
