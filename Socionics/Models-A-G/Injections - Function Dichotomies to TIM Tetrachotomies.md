...
|     Leading/Following     | $V_{1} \cap A_{3} \cap D_{1} \cap C_{3}$ |        IProcess Implementation, Result Project Groups         |
| Accelerating/Decelerating | $G_{1} \cap A_{4} \cap D_{2} \cap C_{3}$ | Dual Axis (Asymmetric Process Passionarity Result Centrality) |
