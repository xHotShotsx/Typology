...
- Waffle: For a pair of dichotomy systems $\mathcal{D}_{i}$ and $\mathcal{D}_{j}$, and a pair of their associated wall subspaces $W_{i}$ and $W_{j}$, a "waffle" dichotomy is the output of the product of one dichotomy in $W_{i}$ and another in $W_{j}$. Like with the   
