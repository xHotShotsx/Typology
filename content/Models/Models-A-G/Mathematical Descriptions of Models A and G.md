...
Like with $\mathbb{S}$, $H$ can be described by certain permutations such as $B = (1,2,3,4)(5,6,7,8)$ for order 4 relationships and $d = (1,6)(2,7)(3,8)(4,5)$ for order 2 relationships. It can that easily be verified that this permutation group is isomorphic to $\mathbb{Z}_{2} \times \mathbb{Z}_{4}$, that acts on 8 points, and thus easily verifiable that Model G is an example of the transitive permutation group 8T2. 
