...
Finally, the 'Presence Cube' model allows us to construct a vector space on Model A, since $F_{MA}$ has size . that is both faithful and transitive to $\mathbb{S}$. This is the Democratic/Aristocratic subgroup which is isomorphic to $\mathbb{Z}_{2}^3$. 
