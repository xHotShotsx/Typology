...
Finally, the 'Presence Cube' model demonstrates the constructed vector space on Model A. $F_{MA}$ and $I$ have size $2^3$ so we can construct dichotomy systems on them, This is the Democratic/Aristocratic subgroup, which is isomorphic to $\mathbb{Z}_{2}^3$.  
