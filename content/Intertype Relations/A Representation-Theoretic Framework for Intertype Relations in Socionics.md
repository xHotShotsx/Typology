...
$CD(\mathbb{S})$ will generate the 7 orbital dichotomies. Alternatively, any index-2 subgroup in $CD$ will also generate the 7 orbital dichotomies since all of the index-2 subgroups generate them. $CD({} = )$ $CD(\{e,g,x,d,h,i,k,l\} = \rm{Irrational/Rational})$ will generate the Tencer-Minaev dichotomies ($\mathcal{D}_{14}$)    
