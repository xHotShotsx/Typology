...
$CD(\mathbb{S})$ will generate the 7 orbital dichotomies. Alternatively, any index-2 subgroup in $CD$ will also generate the 7 orbital dichotomies since all of the index-2 subgroups generate them. $CD(\{e,g,x,d,h,i,k,l\} = \Irrational/Rational)$ will gen    
