...
$CD(\mathbb{S})$ will generate the 7 orbital dichotomies. Alternatively, any index-2 subgroup of $\mathbb{S}$ will also generate the 7 orbital dichotomies since $\mathbb{S}$ generates them. $CD(\{e,g,x,d,m,c,q,a\} = \rm{Democratic/Aristocratic})$ and $CD(\{e,g,x,d,h,i,k,l\} = \rm{Irrational/Rational})$ will generate the Tencer-Minaev dichotomies ($\mathcal{D}_{14}$). 
