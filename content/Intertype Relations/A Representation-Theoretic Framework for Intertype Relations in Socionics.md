...
$$ \begin{matrix} \text{Subgroup} & \text{Description} & \text{Normal?} & \text{Type} & \text{Quotient} \\ \\ eg & \text{Superegos} & \text{True} & \mathbb{Z}_2 & \mathbb{Z}_2^3 \\ ed & \text{Duals} & \text{True} & \mathbb{Z}_2 & \mathbb{Z}_2^3 \\ ex & \text{Extinguishers} & \text{True} & \mathbb{Z}_2 & \mathbb{Z}_2^3 \\ ek & \text{Kindreds} & \text{False} & \mathbb{Z}_2 & - \\  \end{matrix} $$ 
