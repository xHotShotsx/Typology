...
**Footnote:** A general dichotomy system $\mathfrak{D}$ is said to lie outside $\mathcal{D}$ if it fails to preserve the full orbital subspace. Such systems may exhibit system-relative invariances, but do not admit the selector structure or induced representations developed here. Systems such as the Keirsey-Berens dichotomies, while structurally interesting, do not preserve the universal orbital core and are therefore fall outside of $\mathcal{D}$. (1)
