...
Now, any normal subgroup of order 4 will generate 2 orbital-respecting dichotomy systems, with another set of dichotomies produced by the XOR addition between wall dichotomies of these different spaces (2025). $CD({e,g,x,d} = Z(\mathbb{S}))$ will generate the Reinin dichotomies, the Tencer-Minaev dichotomies
